...
#include "BigMissileBullet.hpp"
#include "Scene/PlayScene.hpp"
#include "Engine/Point.hpp"

class Turret;

BigMissileBullet::BigMissileBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret* parent) :
	Bullet("play/bullet-4.png", 500, 10, position, forwardDirection, rotation + ALLEGRO_PI / 2, parent) {
}
void BigMissileBullet::Update(float deltaTime) {
	if (!Target) {
...
void BigMissileBullet::OnExplode(Enemy* enemy) {
